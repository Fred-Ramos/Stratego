...
#include "../../../Stratego_gui1/Textbox.h"
...
static constexpr auto qt_meta_stringdata_CLASSTextboxENDCLASS = QtMocHelpers::stringData(
    "Textbox",
    "clicked",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTextboxENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTextboxENDCLASS_t qt_meta_stringdata_CLASSTextboxENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7),  // "Textbox"
...
void Textbox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Textbox::*)();
            if (_t _q_method = &Textbox::clicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
